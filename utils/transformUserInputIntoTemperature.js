...
const queryManipulation = require('./manipulateQuery')
const transformUserInputIntoTemperature = async (userInputLocation) => {

  const dasheduserInputLocation = queryManipulation.manipulateQuery(userInputLocation)
    const mapBoxUrl = `https://api.mapbox.com/geocoding/v5/mapbox.places/${dasheduserInputLocation}.json?access_token=${mapBoxToken}`;
